    ...
    return Scaffold(
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
            boxShadow: [BoxShadow(color: dbShadowColor,offset:Offset.fromDirection(3,1),spreadRadius: 1,blurRadius: 5)]
        ),
        child: Db7BottomNavigationBar(
          ...
          selectedIconTheme: IconThemeData(
              color: db7_colorPrimary,size: 24
          ),
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        text(db7_lbl_my_medical,fontFamily: fontBold,fontSize: textSizeLarge),
                ...
                Row(
                  children: <Widget>[
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(text: model.topicLike.toString(), style: TextStyle(
                          ...
                          WidgetSpan(
                            child: Padding(
                                ...
                                child: SvgPicture.asset(db7_ic_like,height: 20,width: 20,color: db7_textColorSecondary,)
                            ),
                          ),
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(text: model.topicCount.toString(), style: TextStyle(
                              fontSize: textSizeMedium,
                              color: db7_textColorSecondary
                          )),
                          WidgetSpan(
                            child: Padding(
                                padding: EdgeInsets.only(left:  8),
                                child: SvgPicture.asset(db7_ic_document,height: 20,width: 20,color: db7_textColorSecondary,)
                            ),
                          ),
