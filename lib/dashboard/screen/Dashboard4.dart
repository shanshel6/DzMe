            ...
            Container(
              ...
              child:Row(
                ...
                children: <Widget>[
                  ...
                  SvgPicture.asset(db4_options,width: 25,height: 25,color: db4_white,)
                ],
              ) ,
            ),
                      ...
                      children: <Widget>[
                        Expanded(
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              text(db4_account_number, textColor: db4_white, fontSize: textSizeMedium,),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: SvgPicture.asset(mFavouriteList[index].icon,color: db4_white,),
                  ),
