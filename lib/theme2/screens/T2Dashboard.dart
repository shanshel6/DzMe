...
import 'package:prokit_flutter/theme2/utils/T2SliderWidget.dart';
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  text(mFavouriteList[position].name,
                                      textColor: t2TextColorPrimary,
                                      fontFamily: fontBold,
                                      fontSize: textSizeNormal,maxLine: 2),
                                  SizedBox(height: 8),
                                  Row(
                                    mainAxisAlignment:
      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            SizedBox(width: 20),
            text(name,
                textColor: selectedItem == pos ? t2_colorPrimary : t2TextColorPrimary,
