        ...
        children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Image.asset(t2_profile,width: 80,height: 80,),
                                    ),
                                    SizedBox(
                                      width: 24,
                                    ),
                        ...
                        Container(
                          ...
                          child:Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                text(t2_lbl_personal,textColor: t2TextColorPrimary,fontFamily: fontMedium,fontSize: 21.0),
                                EditText(isPassword: false,mController: nameController,fontSize: textSizeLargeMedium,),
                                DropdownButton<String>(
                                  value: _selectedLocation,
                                  items: <String>['Female', 'Male'].map((String value) {
                                    return new DropdownMenuItem<String>(
                                      value: value,
                                      child: text(value,fontSize: textSizeLargeMedium,textColor: t2TextColorPrimary),
                                    );
                                  }).toList(),
                                  onChanged: (newValue) {
                                    setState(() {
                                ...
                                EditText(isPassword: false,mController: addressController,maxLine: 2,fontSize: textSizeLargeMedium,),
                                SizedBox(height: 30),
                                text(t2_lbl_contacts,textColor: t2TextColorPrimary,fontFamily: fontMedium,fontSize: 21.0),
                                EditText(isPassword: false,mController: contactController,fontSize: textSizeLargeMedium,),
                                EditText(isPassword: false,mController: emailController,fontSize: textSizeLargeMedium,),
                              ],
                            ),
                          ) ,
                        )
          ...
          Align(
            ...
            child: Container(
              ...
              child: text(t2_lbl_save,textColor: t2_white,fontFamily: fontMedium),
            ),
          )
