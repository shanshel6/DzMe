                    ...
                    Container(
                      child:Stack(
                        children: <Widget>[
                          ...
                          RotatedBox(
                            quarterTurns: -1,
                            child: text("Edit",textColor: t2_white,isCentered: true,latterSpacing: 5.0,fontFamily: fontSemibold),
                          )
                        ],
                    ...
                    Container(
                      child:Stack(
                        children: <Widget>[
                          ...
                          RotatedBox(
                            quarterTurns: -1,
                            child: text("Remove",textColor: t2_white,isCentered: true,latterSpacing: 5.0,fontFamily: fontSemibold),
                          )
                        ],
                        alignment: Alignment.center,
                      ) ,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: <Widget>[
                                          ...
                                          child: Container(
                                            ...
                                            child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                text(mFavouriteList[index].duration,fontSize: textSizeMedium),
                                              ],
                                            ),
                                          ),
                                        )
                                    ...
                                    SizedBox(height: 16,),
                                    text(t2_samplelong_text,fontSize: textSizeMedium,maxLine: 2),
