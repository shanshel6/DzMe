...
class ShProduct {
    ...
    ShProduct({this.id, this.name, this.date_created, this.date_created_gmt, this.date_modified, this.date_modified_gmt, this.type, this.status, this.featured, this.catalog_visibility, this.description, this.short_description, this.sku, this.price, this.regular_price, this.sale_price, this.price_html, this.on_sale, this.purchasable, this.total_sales, this.virtual, this.downloadable, this.downloads, this.download_limit, this.download_expiry, this.external_url, this.button_text, this.tax_status, this.tax_class, this.manage_stock, this.stock_quantity, this.stock_status, this.backorders, this.backorders_allowed, this.backordered, this.sold_individually, this.weight, this.dimensions, this.shipping_required, this.shipping_taxable, this.shipping_class, this.shipping_class_id, this.reviews_allowed, this.average_rating, this.rating_count, this.related_ids, this.upsell_ids, this.cross_sell_ids, this.parent_id, this.purchase_note, this.categories, this.tags, this.images, this.attributes, this.default_attributes});
