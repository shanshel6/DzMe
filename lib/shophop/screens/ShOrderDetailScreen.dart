...
class ShOrderDetailScreenState extends State<ShOrderDetailScreen> {
  ...
  var orderStatus=Container(
    ...
    child:  IntrinsicHeight(
      child: Row(
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              Container(margin: EdgeInsets.only(top:4.0),width: 10.0,height: 10.0,decoration: BoxDecoration(shape: BoxShape.circle,color: Colors.amber),),
              Expanded(
              ...
              Container(margin: EdgeInsets.only(bottom:4.0),width: 10.0,height: 10.0,decoration: BoxDecoration(shape: BoxShape.circle,color: Colors.grey),),
            ],
          ),
    ...
    var paymentDetail = Container(
      margin: EdgeInsets.only(
          left:spacing_standard_new, right:spacing_standard_new, top:spacing_standard_new),  decoration:
      BoxDecoration(border: Border.all(color: sh_view_color, width: 1.0)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
