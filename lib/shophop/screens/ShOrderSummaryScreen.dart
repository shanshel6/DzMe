...
class ShOrderSummaryScreenState extends State<ShOrderSummaryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var cartList = isLoaded?ListView.builder(
    ...
    var paymentDetail = Container(
      margin: EdgeInsets.fromLTRB(
          spacing_standard_new, spacing_standard_new, spacing_standard_new, spacing_standard_new),
      decoration:
        ...
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: MaterialButton(
              ...
              child: text(
                  sh_lbl_change_address,
                  fontSize: textSizeMedium,fontFamily: fontMedium,textColor: sh_white
              ),
