...
class ShHomeFragmentState extends State<ShHomeFragment> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: newestProducts.isNotEmpty?SingleChildScrollView(
        child: Container(
          child: Column(
            children: <Widget>[
              Container(
                      ...
                      return InkWell(
                        onTap: (){
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ShSubCategory(category: list[index])));
                        },
                        child: Container(
              ...
              horizontalHeading(sh_lbl_newest_product,callback: (){
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ShViewAllProductScreen(prodcuts: newestProducts,title: sh_lbl_newest_product,)));
              }),
              ...
              horizontalHeading(sh_lbl_Featured,callback: (){
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ShViewAllProductScreen(prodcuts: featuredProducts,title: sh_lbl_Featured,)));
              }),
