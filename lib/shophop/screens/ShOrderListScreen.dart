                         ...
                         child: IntrinsicHeight(
                           child: Row(
                             ...
                             children: <Widget>[
                               Column(
                                 children: <Widget>[
                                   Container(width: spacing_standard,height: spacing_standard,decoration: BoxDecoration(shape: BoxShape.circle,color: Colors.yellow),),
                                   Expanded(
                                   ...
                                   Container(width: spacing_standard,height: spacing_standard,decoration: BoxDecoration(shape: BoxShape.circle,color: Colors.grey),),
                                 ],
                               ),
                               Expanded(
                                 child: Column(
