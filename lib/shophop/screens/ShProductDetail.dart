...
class ShProductDetailState extends State<ShProductDetail> {
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              text(widget.product.on_sale?widget.product.sale_price.toCurrencyFormat():widget.product.price.toCurrencyFormat(),textColor: sh_colorPrimary,fontSize: textSizeXNormal,fontFamily: fontMedium)
            ],
    ...
    var colorList = widget.product.attributes
        .firstWhere((attribute) => attribute.name == "Color")
        .options;
    ...
    var sizeList = widget.product.attributes
        .firstWhere((attribute) => attribute.name == "Size")
        .options;
    var brandList = widget.product.attributes
            ...
            child: Container(
              ...
              decoration: selectedSize == index
                  ? BoxDecoration(
                      shape: BoxShape.circle,
                      border:
                          Border.all(color: sh_textColorPrimary, width: 0.5),
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Container(
                      ...
                      child: text(
                          widget.product.dimensions.length + " cm",
                          textColor: sh_textColorPrimary,
                          fontFamily: fontMedium,
                          fontSize: textSizeLargeMedium)),
                )
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Container(
                      ...
                      color: sh_itemText_background,
                      child: text(
                          widget.product.dimensions.height + " cm",
                          textColor: sh_textColorPrimary,
                          fontFamily: fontMedium,
                          fontSize: textSizeLargeMedium)),
                )
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Container(
                      ...
                      color: sh_itemText_background,
                      child: text(
                          widget.product.dimensions.width + " cm",
                          textColor: sh_textColorPrimary,
                          fontFamily: fontMedium,
                          fontSize: textSizeLargeMedium)),
                )
                  ...
                  SliverPersistentHeader(
                    delegate: _SliverAppBarDelegate(
                      TabBar(
                        ...
                        tabs: [
                          Tab(
                            text: sh_lbl_description,
                          ),
                          Tab(
                            text: sh_lbl_tab_more_info,
                          ),
                          Tab(
                            text: sh_lbl_reviews,
                          ),
                              ...
                              Expanded(
                                child: MaterialButton(
                                  ...
                                  child: text(sh_lbl_submit,
                                      fontSize: textSizeNormal, textColor: sh_white),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: new BorderRadius.circular(5.0),
                                  ),
                                  onPressed: () {
