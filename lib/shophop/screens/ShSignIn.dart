        ...
        child: Stack(
          ...
          children: <Widget>[
            Positioned(
              ...
              child: Image.asset(ic_app_background,height: width+width*0.05,width: width,fit: BoxFit.fill,),
            ),
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: MaterialButton(
                        ...
                        child: text(
                          sh_lbl_sign_in,
                         fontSize: textSizeNormal,fontFamily: fontMedium,textColor: sh_white
                        ),
                        textColor: sh_white,
                    ...
                    SizedBox(
                      ...
                      child: MaterialButton(
                        ...
                        child: text(
                            sh_lbl_sign_up,
                            fontSize: textSizeNormal,fontFamily: fontMedium,textColor: sh_colorPrimary
                        ),
                        textColor: sh_white,
                        shape: RoundedRectangleBorder(
                            borderRadius: new BorderRadius.circular(40.0),
                        ...
                        color: sh_white,
                        onPressed: () => {
                         launchScreen(context, ShSignUp.tag)
                        },
                      ),
                    )
                  ],
