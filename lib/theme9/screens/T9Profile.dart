        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      ...
                      child: CircleAvatar(
                          backgroundImage: AssetImage(t9_ic_profile),
                          radius: width / 8.5),
                    ),
                    SizedBox(width: 20,),
                    Column(
              ...
              Container(margin: EdgeInsets.only(top: 30,left: 16),child: text(t9_lbl_general,fontFamily: fontBold,textAllCaps: true)),
              SizedBox(height: 10,),
              Container(
                decoration: boxDecoration(bgColor: t9_white,showShadow: true,radius: 0),
                child: Column(
                  children: <Widget>[
              ...
              Container(margin: EdgeInsets.only(top: 25,left: 16),child: text(t9_lbl_settings,fontFamily: fontBold,textAllCaps: true)),
              SizedBox(height: 10,),
              Container(
                decoration: boxDecoration(bgColor: t9_white,showShadow: true,radius: 0),
                child: Column(
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            Container(
              decoration: boxDecoration(
                  bgColor: t9_white,radius: 8,showShadow: true),
              width: 40,
              height: 40,
