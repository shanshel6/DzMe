    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            decoration:
                boxDecoration(showShadow: true, bgColor: t9_white, radius: 0),
              ...
              children: <Widget>[
                    ...
                    children: [
                      WidgetSpan(
                        child: Padding(
                          ...
                          child: Icon(Icons.search,color: t9_colorPrimary,size: 20,),
                        ),
                      ),
                      TextSpan(text: t9_hint_search,style: TextStyle(
                ...
                RichText(
                  text: TextSpan(
                    style: Theme.of(context).textTheme.body1,
                    children: [
                      TextSpan(text: t9_lbl_filter,style: TextStyle(
                          fontSize: textSizeMedium,
                      ...
                      WidgetSpan(
                        child: Padding(
                          padding: const EdgeInsets.symmetric(horizontal:   8.0),
                          child: Icon(Icons.close,color: t9_textColorSecondary,size: 20,),
                        ),
                      ),
