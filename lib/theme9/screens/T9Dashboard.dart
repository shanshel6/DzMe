          ...
          children: <Widget>[
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  text(t9_lbl_featured, fontFamily: fontBold,fontSize: textSizeNormal),
                  text(t9_lbl_see_all,
                      textColor: t9_colorPrimary, textAllCaps: true,fontFamily: fontMedium,)
                ],
              ),
            ),
            SizedBox(
            ...
            Container(margin:EdgeInsets.only(left: 16),child: text(t9_lbl_categories, fontFamily: fontBold,fontSize: textSizeNormal)),
            SizedBox(height: 10,),
            Expanded(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                text(model.name, fontFamily: fontMedium,isLongText: true,maxLine: 2),
