...
BoxDecoration boxDecoration(
  ...
  return BoxDecoration(
      ...
      boxShadow: showShadow
          ? [BoxShadow(color: grocery_ShadowColor, blurRadius: 10, spreadRadius: 3)]
...
Widget title(var title,Color headerColor,Color textColor,BuildContext context) {
  return  Stack(
    children: <Widget>[
      Container(color: headerColor, height: 100),
      Padding(
            ...
            Row(
              children: <Widget>[
                ...
                text(title,
                    ...
                    fontFamily: fontBold,isCentered: true).paddingOnly(left: spacing_standard,top: 26)
              ],
            ).paddingOnly(top:spacing_standard_new,left: spacing_standard,right: spacing_standard,bottom: spacing_standard_new),
          ],
        ),
      )
    ],
...
Widget title1(var title,Color color1,Color textColor,BuildContext context) {
  return  Stack(
    children: <Widget>[
      Container(color: color1, height: 100),
      Padding(
        padding: EdgeInsets.fromLTRB(0, 0, 4, 0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
