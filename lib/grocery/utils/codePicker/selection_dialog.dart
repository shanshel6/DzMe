...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  Widget build(BuildContext context) => SimpleDialog(
      title: Column(
        ...
        children: <Widget>[
          text("Select Country Code",textColor: grocery_textColorPrimary,fontSize: textSizeNormal,fontFamily: fontSemiBold),
          TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(),fontSize: textSizeMedium,textColor: grocery_textColorPrimary)),
                text(e.dialCode,fontSize: textSizeMedium,textColor: grocery_textColorPrimary,fontFamily: fontSemiBold),
              ],
            ),
          ),
        ],
