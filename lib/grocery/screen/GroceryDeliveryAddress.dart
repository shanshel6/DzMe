            ...
            children: <Widget>[
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        text("Enter delivery address",fontSize: textSizeLarge,fontFamily: fontMedium).paddingOnly(left: spacing_standard,right: spacing_standard,),
                        text("Your Delivery address",textColor: grocery_textColorSecondary,).paddingOnly(left: spacing_standard,right: spacing_standard,),
                      ],
                    )
                  ],
                ),
             ...
             SizedBox(height: spacing_standard_new,),
              Align(
                ...
                child: Container(
                  width: width * 0.35,
                  child: groceryButton(textContent: grocery_lbl_Save,color: grocery_colorPrimary,onPressed: (() {
