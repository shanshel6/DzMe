            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  CircleAvatar(
                    radius: width*0.11,
                    backgroundImage: AssetImage(grocery_ic_user1),
                  ).paddingOnly(left: spacing_standard_new,top: 20.0),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                    ...
                    return GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              Container(
                                ...
                                child: Image.asset(profileList[index].icon,height: 10,width: 10,color: grocery_color_white,).paddingAll(12),
                          ...
                          Divider().paddingOnly(bottom: spacing_control),
                        ],
                      ),
                    );
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      text(grocery_lbl_confirmation_for_logout,textColor: grocery_textColorSecondary,fontSize: textSizeLargeMedium,).paddingOnly(left: spacing_standard,right: spacing_standard)
                    ],
                  ),
                ],
              ),
