...
class GrocerySignUp extends StatefulWidget {
  ...
  @override
  _GrocerySignUpState createState() =>
      _GrocerySignUpState(
      );
}
    ...
    final signIn = Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          text(grocery_lbl_Enter_email_password_to_continue,textColor: grocery_textColorSecondary,fontSize: textSizeLargeMedium,).paddingOnly(left: spacing_standard_new,right: spacing_standard_new),
          EditText(text: grocery_lbl_Email_Address,isPassword: false,keyboardType: TextInputType.emailAddress,).paddingAll(spacing_standard_new),
          EditText(text:  grocery_lbl_Password,isPassword: true,).paddingAll(spacing_standard_new),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              text("$grocery_lbl_Forgot_password?",fontSize: textSizeLargeMedium,fontFamily: fontMedium).paddingOnly(left: spacing_standard_new,right: spacing_standard_new,bottom: spacing_standard_new).onTap(() {
                GroceryForgotPassword().launch(context);
              }),
              Container(
                width: width * 0.35,
                child: groceryButton(textContent: grocery_lbl_Sign_In,onPressed: (() {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Align(
            ...
            child: Container(
              width: width * 0.35,
              child: groceryButton(textContent: grocery_lbl_Next,onPressed: (() {
