              ...
              Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      text("Enter recipient",textColor: grocery_textColorPrimary,fontSize: textSizeLarge,fontFamily: fontMedium).paddingOnly(left: spacing_standard,right: spacing_standard,),
                      text("one who receives shopping items",textColor: grocery_textColorSecondary,).paddingOnly(left: spacing_standard,right: spacing_standard,),
                    ],
                  )
                ],
              ),
              SizedBox(height: spacing_standard,),
              EditText(text: "Ishan Maduskha",fontSize: textSizeLargeMedium,isPassword: false,).paddingAll(spacing_standard_new),
              Row(
                children: <Widget>[
                  Column(
                    children: <Widget>[
