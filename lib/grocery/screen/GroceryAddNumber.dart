  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: title(grocery_lbl_Add_Number,grocery_colorPrimary,grocery_color_white, context),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              text(grocery_lbl_Enter_your_Mobile,textColor: grocery_textColorSecondary,fontSize: textSizeLargeMedium,).paddingOnly(left: spacing_standard_new,right: spacing_standard_new),
              Row(
                children: <Widget>[
                  Column(
                    children: <Widget>[
                  ...
                  Expanded(
                    child: EditText(text: grocery_hint_Enter_mobile_number,isPassword: false,keyboardType: TextInputType.number).paddingOnly(left: spacing_standard_new,right: spacing_standard_new),
                  )
                ],
              ...
              Align(
                ...
                child: Container(
                  width: width * 0.35,
                  child: groceryButton(textContent: grocery_lbl_send,onPressed: (() {
