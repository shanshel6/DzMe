              ...
              Row(
                children: <Widget>[
                  Container(
                    ...
                    child: Image.asset(Grocery_ic_bag,height: 10,width: 10,color: grocery_color_white,).paddingAll(spacing_standard_new),
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      text(grocery_Only_from_Outlet,textColor: grocery_textColorSecondary,).paddingOnly(left: spacing_standard,right: spacing_standard,),
                    ],
                  )
                ],
              ),
