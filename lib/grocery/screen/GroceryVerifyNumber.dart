          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  text("4 digit code send to",textColor: grocery_textColorSecondary,fontSize: textSizeLargeMedium,fontFamily: fontRegular).paddingOnly(left: spacing_standard_new,),
                  text("+94 7187876789",textColor: grocery_textGreenColor,fontSize: textSizeLargeMedium,fontFamily: fontRegular).paddingOnly(left: spacing_standard,right: spacing_standard_new),
                ],
              ),
              ...
              Row(
                ...
                children: <Widget>[
                  _start == 0 ? text("Resend",textColor: grocery_textColorSecondary,fontSize: textSizeLargeMedium,fontFamily: fontMedium).paddingOnly(left: spacing_standard_new,bottom: spacing_standard_new).onTap(() {
                    startTimer();
                    _start = 9;
                    setState(() {});
                  ...
                  Container(
                    width: width * 0.35,
                    child: groceryButton(textContent: grocery_lbl_Verify,onPressed: (() {
