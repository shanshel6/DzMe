                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                                width: width * 0.35,
                                child: groceryButton(textContent: grocery_lbl_remove,onPressed: (() {
        ...
        children: <Widget>[
               ...
               child:  Column(
                 ...
                 children: <Widget>[
                   Row(
                     ...
                     children: <Widget>[
                       text(model.name,fontSize: textSizeLargeMedium,
                         fontFamily: fontMedium,),
                       IconButton(onPressed: (){ mRemoveItem(); },icon: Icon(Icons.delete_outline,color: grocery_icon_color,),)
                     ],
                   ),
                   Row(
                     children: <Widget>[
                       text(grocery_msg_subtotal, fontFamily: fontMedium,),
                       SizedBox(width: spacing_control_half,),
                       text(grocery_lbl_rs+" "+model.price, fontFamily: fontMedium,),
                     ],
                   ),
                   Row(
                     children: <Widget>[
                       text(grocery_lbl_total_items, fontFamily: fontMedium,),
                       SizedBox(width: spacing_control_half,),
                       text(model.totalItem, fontFamily: fontMedium,),
                     ],
                   )
                 ],
               ),
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Container(
                  width: width * 0.38,
                  child: groceryButton(textContent: grocery_lbl_checkout,onPressed: (() {
