        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      text("Select delivery area",fontSize: textSizeLarge,fontFamily: fontMedium).paddingOnly(left: spacing_standard,right: spacing_standard,),
                      text("Delivery charges apply",textColor: grocery_textColorSecondary,fontSize: textSizeLargeMedium,).paddingOnly(left: spacing_standard,right: spacing_standard,),
                    ],
                  )
                ],
              ),
              ...
              EditText(text: "424/ 1D, Palanwattam, Pannipitiya",isPassword: false,).paddingOnly(top: spacing_standard,left: spacing_standard_new,right: spacing_standard_new),
              SizedBox(height: spacing_standard_new,),
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  groceryButton1(textContent: grocery_lbl_Save, onPressed: () {
                  }).paddingOnly(right: spacing_standard,bottom: spacing_standard_new),
                  Container(
                    width: width * 0.35,
                    child: groceryButton(textContent: grocery_lbl_Next,color: grocery_colorPrimary,onPressed: (() {
