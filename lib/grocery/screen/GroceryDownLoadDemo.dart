        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Image.asset(Grocery_ic_Android,height: width * 0.2,width: width * 0.2,fit: BoxFit.fill,).paddingAll(spacing_standard),
            ...
            SizedBox(height: spacing_xxLarge,),
            SizedBox(height: spacing_xxLarge,),
            groceryButton(textContent:  grocery_lbl_View_Behance_Project,bgColors: grocery_DarkBlue_Color, onPressed: () {
            }).paddingAll(spacing_xxLarge),
            groceryButton(textContent: grocery_lbl_Download_Demo,bgColors: grocery_blue_Color, onPressed: () {
            }).paddingOnly(left:spacing_xxLarge,right: spacing_xxLarge),
            groceryButton(textContent: grocery_lbl_View_Dribble_Shot,bgColors: grocery_Pink_Color, onPressed: () {
