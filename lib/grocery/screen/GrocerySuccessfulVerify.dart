                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            text(grocery_lbl_Congratulations,fontSize: textSizeXLarge,fontFamily: fontBold).paddingOnly(top: spacing_standard_new,left: spacing_standard_new,right: spacing_standard_new),
                            text(grocery_lbl_Cong_Msg,textColor: grocery_textColorPrimary,isLongText: true).paddingOnly(left: spacing_standard_new,right: spacing_standard_new),
                          ],
                        ),
                      ],
                    ),
