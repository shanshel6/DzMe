                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          text(
                            grocery_totalItems + ': ' + listCompleated[index].totelItem,
                            fontSize: textSizeMedium,
                            fontFamily: fontMedium,
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            appBar: PreferredSize(
              preferredSize: Size.fromHeight(MediaQuery.of(context).size.width*0.35),
              child: Container(
                color: grocery_colorPrimary,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        ).paddingOnly(right: 24).onTap((){back(context);}),
