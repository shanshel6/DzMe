        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              EditText(text: "Ishan Maduskha",isPassword: false,).paddingAll(spacing_standard_new),
              EditText(text: "ish.maduskha@gmail.com",isPassword: false,keyboardType: TextInputType.emailAddress,).paddingAll(spacing_standard_new),
              Row(
                children: <Widget>[
                  Column(
                    children: <Widget>[
