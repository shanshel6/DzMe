  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          searchController.text.isNotEmpty?IconButton(icon: Icon(Icons.clear,color: grocery_color_white,),onPressed: (){
          },):Container()
        ],
      ),
      ...
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              Image.asset(Grocery_ic_DeliveryBoy,width: width*0.4,height: width*0.4,),
