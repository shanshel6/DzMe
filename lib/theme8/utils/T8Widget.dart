...
class ButtonConformed extends StatefulWidget {
  var textContent;
  ...
  @override
  _ButtonConformedState createState() => _ButtonConformedState();
}

class _ButtonConformedState extends State<ButtonConformed> {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: boxDecoration(bgColor: Colors.green[500], radius: 16),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
          ...
          decoration: boxDecoration(bgColor: Colors.red[600], radius: 16),
          padding: EdgeInsets.fromLTRB(16, 10, 16, 10),
          child: Stack(
            alignment: Alignment.center,
            children: <Widget>[
