...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  Widget build(BuildContext context) => SimpleDialog(
      title: Column(
        ...
        children: <Widget>[
          text("Select Country Code",textColor: quiz_textColorPrimary,fontSize: textSizeNormal,fontFamily: fontSemibold),
          TextField(
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(child: text(e.toLongString(),fontSize: textSizeMedium,textColor: quiz_textColorPrimary)),
                text(e.dialCode,fontSize: textSizeMedium,textColor: quiz_textColorPrimary,fontFamily: fontSemibold),
              ],
            ),
          ),
        ],
