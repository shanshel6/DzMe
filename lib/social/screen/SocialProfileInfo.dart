            ...
            list.add(
              PopupMenuItem(
                child: GestureDetector(
                  onTap: (){launchScreen(context, SocialVerify.tag);},
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                          ...
                          style: TextStyle(
                              fontSize: textSizeMedium, color: social_white)),
                    ],
                  ),
                ),
              )),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SocialOption(
                          ...
                          social_blue,
                          social_ic_lock,
                          social_lbl_encryption,
                          social_lbl_encryption_info),
                    ],
                  ),
                ),
                Container(
          ...
          Row(
            ...
            children: <Widget>[
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Container(
                    padding: EdgeInsets.all(4),
                    child:
                      Icon(Icons.close, color: social_textColorPrimary),
                  ),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  padding: EdgeInsets.all(4),
                  decoration: BoxDecoration(shape: BoxShape.circle,color: social_form_google,),
                  child: Container(
                    padding: EdgeInsets.all(4),
                    child:
                    Icon(Icons.check, color: social_white),
                  ),
                ),
              ),
            ],
