                            ...
                            RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                      text: social_lbl_deleting_your_account_will,
                                      style: TextStyle(
                            ...
                            RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(text: social_lbl_change_phone_number_instead,style: TextStyle(
                                      fontSize: textSizeMedium,
                                  ...
                                  children: [
                                    WidgetSpan(
                                      child: Padding(
                                        padding: const EdgeInsets.symmetric(horizontal: 8.0),
                                        child: Icon(
                                          Icons.call, color: social_textColorPrimary,
                                          size: 18,),
                                      ),
                                    ),
                                    TextSpan(text: social_phone, style: TextStyle(
