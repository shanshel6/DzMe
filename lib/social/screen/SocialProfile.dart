            ...
            children: [
              WidgetSpan(
                child: Padding(
                  ...
                  child: Icon(
                    icon, color: social_textColorPrimary,
                    size: 18,),
                ),
              ),
    ...
    return Stack(
      ...
      children: <Widget>[
        ClipRRect(
          ...
          child: Image.asset(
            social_ic_user1, height: width * 0.25, width: width * 0.25,fit: BoxFit.fill,),),
        Container(
          width:  width * 0.075,
          ...
          child: Icon(Icons.camera,color: social_white,size: 16,),
        )
      ],
    );
  }
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      mOption(social_name,Icons.person_outline,tag: SocialProfileInfo.tag),
