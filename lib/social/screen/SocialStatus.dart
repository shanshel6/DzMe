        ...
        Row(
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
               GestureDetector(
                 onTap: (){launchScreen(context, SocialGallery.tag);},
                 child:  Stack(
                   ...
                   children: <Widget>[
                     ClipRRect(
                       ...
                       child: Image.asset(
                         social_ic_user1, height: width * 0.13, width: width * 0.13,fit: BoxFit.cover,),),
                     Container(
                       alignment: Alignment.bottomRight,
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    text(social_lbl_tap_to_add_status, textColor: social_textColorSecondary,)
                  ],
                ),
              ],
            ),
                ...
                child: Padding(padding: EdgeInsets.all(10.0),
                    child: CircleAvatar(
                      ...
                      child:  Container(
                        color: social_white,
                        child: Image.asset(
                            model.image, height: width * 0.2, width: width * 0.2,fit: BoxFit.cover,),
                      ),
                    )
                ),
