          ...
          Stack(
            ...
            children: <Widget>[
              Container(
                ...
                child: CircleAvatar(
                    backgroundImage: AssetImage(quiz_img_People2),
                      ...
                      itemBuilder: (BuildContext context, int index) =>
                          GestureDetector(
                            ...
                            child: Container(
                              child: Row(
                                children: <Widget>[
                                  Image.asset(mList[index].img,height: 50,width: 50,).paddingOnly(right: 8),
                                  Column(
                  ...
                  itemBuilder: (BuildContext context, int index) =>
                      GestureDetector(
                        ...
                        child: Container(
                          child: Row(
                            children: <Widget>[
                              Image.asset(mList1[index].img,height: 50,width: 50,fit: BoxFit.fill,).cornerRadiusWithClipRRect(25).paddingOnly(right: 16),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
