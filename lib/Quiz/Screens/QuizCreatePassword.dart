            ...
            child: Column(
              children: <Widget>[
                text(quiz_info_create_password,
                        ...
                        isLongText: true,isCentered: true).paddingOnly(left: 40,right: 40,top: 16),
                SizedBox(height: 50,),
                Container(
                    ...
                    children: <Widget>[
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          labelStyle:
                          primaryTextStyle(size: 20, color: quiz_textColorPrimary),
                ...
                Container(
                    margin: EdgeInsets.all(24.0),
                    child: quizButton(
                        textContent: quiz_lbl_continue, onPressed: () {
                      setState(() {
