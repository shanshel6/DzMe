      ...
      child: Stack(
        children: <Widget>[
          ClipRRect(
            ...
            child: Image.asset(
              food_lbl_cake_ice_cream_and_bakery,
              height: width * 0.3,
              fit: BoxFit.fill,
            ),
          ),
            ...
            child: Column(
              children: <Widget>[
                Container(
                    ...
                    width: width,
                    decoration: gradientBoxDecoration(
                        gradientColor1: food_color_green_gradient2,
                        gradientColor2: food_color_green_gradient1,
                        radius: 0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        CircleAvatar(
                          backgroundImage: AssetImage(food_ic_user1),
                          radius: 40,
                        ),
                        text(food_username,
