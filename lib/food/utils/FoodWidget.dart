...
Widget mAddress(BuildContext context) {
  return Container(
    ...
    child: Row(
      ...
      children: <Widget>[
        Expanded(child: text(food_lbl_address_dashboard),flex: 3,),
        Expanded(
          flex: 1,
          ...
          child: IntrinsicHeight(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: (){launchScreen(context, FoodAddAddress.tag);},
                  child: RichText(
                    text: TextSpan(
                      children: [
                        WidgetSpan(
        ...
        text: TextSpan(
          children: [
            ...
            TextSpan(
                text: value,
                style: TextStyle(
                    fontSize: textSizeSMedium, color: food_colorPrimary)),
          ],
        ),
      ),
    ),
    ...
    return Visibility(
      ...
      replacement: GestureDetector(
        ...
        child: Container(
          ...
          height: width * 0.08,
          decoration:
              boxDecoration(color: food_textColorPrimary, radius: spacing_control),
  ...
  return Container(
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        GestureDetector(
          onTap: (){launchScreen(context, tags);},
          child: Container(
