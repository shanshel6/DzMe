          ...
          children: <Widget>[
            ...
            Expanded(
              child:SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    mOption(qibus_ic_user,QIBus_lbl_edit_profile,QIBusEditProfile.tag),
                    mOption(qibus_ic_wallet,QIBus_lbl__wallet,QIBusWallet.tag),
                    mOption(qibus_ic_card_line,QIBus_lbl_cards,QIBusCards.tag),
                    mOption(qibus_ic_refer,QIBus_lbl_refer_and_earn,QIBusReferEarn.tag),
                    mOption(qibus_ic_setting,QIBus_text_settings,QIBusSetting.tag),
                      ...
                      child:       Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Icon(Icons.keyboard_arrow_right,color: qIBus_icon_color,)
                          ],
                        ),
                      ),
                    ),
                    SizedBox(height: spacing_standard_new,),
                    Image.asset(qibus_ic_buslogo,width: width*0.2,),
