                                ...
                                child:  Row(
                                  ...
                                  children: <Widget>[
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.only(topRight: Radius.circular(spacing_standard_new),bottomRight: Radius.circular(spacing_standard_new),),
  ...
  return Container(
    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        GestureDetector(
         onTap: (){launchScreen(context, QIBusPickDrop.tag);},
         child:  Container(
