                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: new GestureDetector(
                                ...
                                child: new Icon(
                                    passwordVisible ? Icons.visibility : Icons.visibility_off,color: qIBus_icon_color,),
                              ),
  ...
  return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Icon(Icons.check_circle,color: qIBus_color_check,size: 50,),
          SizedBox(height: spacing_standard_new,),

          text(QIBus_text_payment_success,fontFamily: fontMedium),
          Padding(
            padding: EdgeInsets.fromLTRB(spacing_large,0,spacing_large,0),
            child: text(QIBus_msg_success,textColor: qIBus_textChild,isLongText: true,isCentered: true),
          ),
          SizedBox(height: spacing_standard_new,),
          Container(
