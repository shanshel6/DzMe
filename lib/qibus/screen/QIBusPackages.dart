    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: (){launchScreen(context, QIBusViewPackage.tag);},
              ...
              child: Column(
                children: <Widget>[
                  ClipRRect(
                    ...
                    child: Image.asset(list.image,height: width*0.32,width: width,fit: BoxFit.fill,),
                  ),
                  Padding(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                SvgPicture.asset(qibus_ic_home_package,color: qIBus_icon_color,width: 20,height: 20,),
                                SizedBox(width: spacing_control_half,),
                                SvgPicture.asset(qibus_ic_bus,color: qIBus_icon_color,width: 20,height: 20,),
                                SizedBox(width: spacing_control_half,),
                                SvgPicture.asset(qibus_ic_restaurant,color: qIBus_icon_color,width: 20,height: 20,),
                                SizedBox(width: spacing_control_half,),
                                SvgPicture.asset(qibus_ic_wifi,color: qIBus_icon_color,width: 20,height: 20,),
                              ],
                            )
