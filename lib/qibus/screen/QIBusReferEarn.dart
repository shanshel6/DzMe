...
class QIBusReferEarnState extends State<QIBusReferEarn> {
  ...
  Widget mLink () {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: <Widget>[
        text(QIBus_txt_your_link, textColor: qIBus_textChild,
          fontSize: textSizeSMedium,),
        text(QIBus_text_link, textColor: qIBus_color_link_blue,
          isLongText: true,
          maxLine: 2,
          fontSize: textSizeSMedium,),
      ],
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(width: 8,),
                        Image.asset(qibus_ic_google,height: 22,width: 22,color: qIBus_colorPrimary,), SizedBox(width: 8,),
                          SvgPicture.asset(qibus_ic_twitter,height: 22,width: 22,), SizedBox(width: 8,),
