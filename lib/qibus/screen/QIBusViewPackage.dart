      ...
      child: Column(
        children: <Widget>[
          ClipRRect(
            ...
            child: Image.asset(model.image,height: width*0.32,width: width,fit: BoxFit.fill,),
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        SvgPicture.asset(qibus_ic_home_package,color: qIBus_icon_color,),
                        SizedBox(width: spacing_control_half,),
                        SvgPicture.asset(qibus_ic_bus,color: qIBus_icon_color,),
                        SizedBox(width: spacing_control_half,),
                        SvgPicture.asset(qibus_ic_restaurant,color: qIBus_icon_color,),
                        SizedBox(width: spacing_control_half,),
                        SvgPicture.asset(qibus_ic_wifi,color: qIBus_icon_color,),
                      ],
                    )
