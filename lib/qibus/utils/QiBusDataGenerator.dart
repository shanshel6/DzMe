...
List<QIBusBookingModel>  QIBusGetBook() {
  ...
  mBookList.add(QIBusBookingModel.booking(QIBus_lbl_DelhiToMubai, QIBus_lbl_booking_date1, QIBus_lbl_booking_starttime1, QIBus_lbl_booking_totaltime1, QIBus_lbl_booking_endtime1, QIBus_lbl_booking_SeatNo1, QIBus_lbl_booking_passenger_name1, QIBus_lbl_booking_ticketno1, QIBus_lbl_booking_pnr1, QIBus_lbl_booking_totalfare1, QIBus_text_confirmed,qibus_ic_completed));
  mBookList.add(QIBusBookingModel.booking(QIBus_lbl_MumbaiToPune, QIBus_lbl_booking_date2, QIBus_lbl_booking_starttime2, QIBus_lbl_booking_totaltime1, QIBus_lbl_booking_endtime2, QIBus_lbl_booking_SeatNo1, QIBus_lbl_booking_passenger_name1, QIBus_lbl_booking_ticketno2, QIBus_lbl_booking_pnr21, QIBus_lbl_booking_totalfare2, QIBus_text_confirmed,qibus_ic_completed));
return mBookList;
}
List<QIBusBookingModel>  QIBusGetCancelBook() {
  List<QIBusBookingModel> mCancelList=List<QIBusBookingModel>();
  mCancelList.add(QIBusBookingModel.booking(QIBus_lbl_MumbaiToPune, QIBus_lbl_booking_date1, QIBus_lbl_booking_starttime1, QIBus_lbl_booking_totaltime1, QIBus_lbl_booking_endtime1, QIBus_lbl_booking_SeatNo1, QIBus_lbl_booking_passenger_name1, QIBus_lbl_booking_ticketno1, QIBus_lbl_booking_pnr1, QIBus_lbl_booking_totalfare1, QIBus_txt_cancelled,qibus_ic_canceled));
return mCancelList;
}
List<QIBusModel>  QIBusGetBusList() {
  List<QIBusModel> mBusList=List<QIBusModel>();
  mBusList.add(QIBusModel(QIBus_lbl_travel_name, QIBus_lbl_booking_starttime1, QIBus_text_am, QIBus_lbl_booking_endtime1, QIBus_text_pm, QIBus_lbl_totalDuration, QIBus_lbl_hold, QIBus_lbl_type1, 3, QIBus_lbl_price1));
  mBusList.add(QIBusModel(QIBus_lbl_travel_name, QIBus_lbl_booking_starttime1, QIBus_text_am, QIBus_lbl_booking_endtime1, QIBus_text_pm, QIBus_lbl_totalDuration, QIBus_lbl_hold, QIBus_lbl_type1, 3, QIBus_lbl_price2));
  mBusList.add(QIBusModel(QIBus_lbl_travel_name, QIBus_lbl_booking_starttime1, QIBus_text_am, QIBus_lbl_booking_endtime1, QIBus_text_pm, QIBus_lbl_totalDuration, QIBus_lbl_hold, QIBus_lbl_type2, 3, QIBus_lbl_price1));
return mBusList;
}
List<QIBusBookingModel>  QIBusGetNotification() {
  List<QIBusBookingModel> mNotificationList=List<QIBusBookingModel>();
  mNotificationList.add(QIBusBookingModel.booking(QIBus_lbl_DelhiToMubai, QIBus_lbl_booking_duration1,  QIBus_lbl_booking_starttime1, QIBus_lbl_booking_totaltime1, QIBus_lbl_booking_endtime1, QIBus_lbl_booking_SeatNo1, QIBus_lbl_booking_passenger_name1, QIBus_lbl_booking_ticketno1, QIBus_lbl_booking_pnr1, QIBus_lbl_booking_totalfare1, QIBus_text_confirmed,qibus_ic_completed));
  mNotificationList.add(QIBusBookingModel.booking(QIBus_lbl_MumbaiToPune, QIBus_lbl_booking_duration2,  QIBus_lbl_booking_starttime2, QIBus_lbl_booking_totaltime1, QIBus_lbl_booking_endtime2, QIBus_lbl_booking_SeatNo1, QIBus_lbl_booking_passenger_name1, QIBus_lbl_booking_ticketno2, QIBus_lbl_booking_pnr21, QIBus_lbl_booking_totalfare2, QIBus_text_confirmed,qibus_ic_completed));
...
List<QIBusCardModel> QIBusGetCards() {
  ...
  mCardList.add(QIBusCardModel(QIBus_lbl_card_type2, qibus_ic_card, QIBus_lbl_card_digit1, QIBus_lbl_card_digit2, QIBus_lbl_card_digit3, QIBus_lbl_card_digit4, QIBus_lbl_card_validdate1, QIBus_lbl_booking_passenger_name1));
  mCardList.add(QIBusCardModel(QIBus_lbl_card_type2, qibus_ic_card3, QIBus_lbl_card_digit2, QIBus_lbl_card_digit4, QIBus_lbl_card_digit1, QIBus_lbl_card_digit3, QIBus_lbl_card_validdate1, QIBus_lbl_booking_passenger_name1));
return mCardList;
}
