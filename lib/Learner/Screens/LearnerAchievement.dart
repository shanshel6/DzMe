                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        text(learner_lbl_achievements,
                            fontSize: textSizeLarge, fontFamily: fontBold,textColor: learner_textColorPrimary),
                        SizedBox(
                          height: 16,
                        ),
                        Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                text(model.name,
                    fontFamily: fontMedium, fontSize: textSizeLargeMedium,textColor: learner_textColorPrimary),
                SizedBox(
                  width: 4,
                ),
        ...
        child: Row(
          children: <Widget>[
            Container(
              ...
              height: MediaQuery.of(context).size.width / 7,
              decoration:
              BoxDecoration(shape: BoxShape.circle, color: learner_met_grey),
              child: Padding(
                padding: const EdgeInsets.all(10.0),
                child: Icon(
                  Icons.lock,
