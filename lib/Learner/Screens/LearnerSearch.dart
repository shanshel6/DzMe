        ...
        body: SafeArea(
          child: Column(
            ...
            children: <Widget>[
              Container(
                decoration:
                boxDecoration(showShadow: true, bgColor: learner_white, radius: 0),
                  ...
                  children: <Widget>[
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(text: learner_hint_search,style: TextStyle(
                    ...
                    RichText(
                      text: TextSpan(
                        style: Theme.of(context).textTheme.body1,
                        children: [
                          TextSpan(text: learner_lbl_filter,style: TextStyle(
                              fontSize: textSizeMedium,
              ...
              Container(
                ...
                child: text(learner_lbl_top_instructors,
                    fontFamily: fontBold, fontSize: textSizeLargeMedium,textColor: learner_textColorPrimary),
              ),
              SizedBox(
                height: 16,
              ),
          ...
          Stack(
            ...
            children: <Widget>[
              ...
              Container(
                height: 15,
                width: 15,
                decoration: BoxDecoration(color: model.isOnline
                    ? learner_green
                    : learner_greyColor.withOpacity(1.0),
                    shape: BoxShape.circle,border: Border.all(color: learner_white,width: 1.5)),
