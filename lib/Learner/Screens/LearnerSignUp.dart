        ...
        children: <Widget>[
          SafeArea(child: Container
            (margin: EdgeInsets.only(left: 16, right: 16),
              child: Icon(Icons.arrow_back, color: learner_colorPrimary, size: 30))),
          Expanded(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Container(alignment: Alignment.center,
                        ...
                        child: CircleAvatar(backgroundImage: AssetImage(learner_ic_Profile), radius: width / 8.5),),
                      SizedBox(height: 30,),
                      ...
                      SizedBox(height: 4,),
                      GestureDetector(
                          child: Text(learner_txt_terms_condition, style: TextStyle(fontSize: textSizeLargeMedium,decoration: TextDecoration.underline, color: t9_colorPrimary,)),
                          onTap: () {
                            Navigator.push(
                              context,
