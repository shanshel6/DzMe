    ...
    return Scaffold(
      ...
      body: GridView(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              Fluttertoast.showToast(msg: "This is error Toast", timeInSecForIos: 3, backgroundColor:  Colors.redAccent, textColor: whiteColor, gravity:  ToastGravity.BOTTOM, toastLength: Toast.LENGTH_SHORT);
