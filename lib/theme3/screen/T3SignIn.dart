                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(t3_lbl_welcome,style: TextStyle(fontSize: 40,fontFamily: fontBold,color: t3_white),),
                          SizedBox(height: 4),
                          Text(t3_lbl_back,style: TextStyle(fontSize: 34,fontFamily: fontBold,color: t3_white),)
                        ],
                      ),
                    )
                  ],
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        child: Text(t3_lbl_sign_up, style: TextStyle(fontSize: textSizeLargeMedium,decoration: TextDecoration.underline, color: t3_colorPrimary,)),
                        onTap: () {
                        }
                    ),
                  )
              ...
              Container(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: Image.asset(t3_ic_sign1,height:80,width: 80 ,)),
                ],
                ),
              )
