            ...
            children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(t3_lbl_create_account,style: TextStyle(fontSize: 34,fontFamily: fontBold,color: t3_white),),
                          SizedBox(height: 4),
                          Text(t3_lbl_recipe_for_happiness,style: TextStyle(fontSize: 20,fontFamily: fontBold,color: t3_white),)
                        ],
                      ),
                    )
                  ],
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                        child: Text(t3_lbl_sign_in, style: TextStyle(fontSize: textSizeLargeMedium,decoration: TextDecoration.underline, color: t3_colorPrimary,)),
                        onTap: () {
                        }
                    ),
                  )
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Image.asset(t3_ic_sign2,height:50,width: 70 ,),
                    Container(
                        margin: EdgeInsets.only(top: 25,left: 10),
                        child: Image.asset(t3_ic_sign4,height:50,width: 70 ,)),
                    Container(
                        margin: EdgeInsets.only(top: 25,left: 10),
                        child: Image.asset(t3_ic_sign3,height:50,width: 70 ,)),
                    Image.asset(t3_ic_sign1,height:80,width: 80 ,),
                  ],
                ),
              )
