              ...
              Row(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: text(t3_lbl_setting,fontFamily: fontBold,textColor: t3_textColorPrimary,fontSize: 22.0),
                    ),
                  )
                ],
              ),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 4,right: 12),
                            child: text(t3_lbl_French,textColor: t3_textColorPrimary,fontSize: textSizeMedium)),
