...
Text headerText(var text) {
  return Text(
    ...
    maxLines: 2,
    style: TextStyle(
        fontFamily: fontBold, fontSize: 22, color: t3_white),
  );
}
...
Text subHeadingText(var text) {
  return Text(
    text,
    style: TextStyle(
        fontFamily: fontRegular, fontSize:textSizeMedium, color: t3_textColorSecondary),
  );
}
Text headingText(var text) {
  return Text(
    text,
    style: TextStyle(
        fontFamily: fontBold, fontSize: textSizeLargeMedium, color: t3_textColorPrimary),
  );
}
Widget text(var text,
    {var fontSize = textSizeLargeMedium,
    textColor = t3_textColorSecondary,
    var fontFamily = fontRegular,var isCentered=false,var maxLine=1,var latterSpacing=0.5,
    var decoration= TextDecoration.underline,var islongTxt=false}) {
  return Text(text,
      textAlign: isCentered? TextAlign.center:TextAlign.start,
      maxLines: islongTxt?null:maxLine,
      style: TextStyle(
          fontFamily: fontFamily, fontSize: fontSize, color: textColor,height: 1.5,letterSpacing: latterSpacing ));
}
...
class EditText extends StatefulWidget {
  ...
  EditText(
      ...
      var this.isSecure = false,var this.text="",var this.mController,var this.maxLine=1});
...
Widget ring(String description){
  return Column(
    ...
    children: <Widget>[
      ...
      SizedBox(height: 16),
      text(description,textColor: t3_textColorPrimary,fontSize: textSizeMedium,fontFamily: fontSemibold,isCentered: true,maxLine: 2)
    ],
  );
}
...
BoxDecoration boxDecoration(
    {double radius = 2,
      ...
      Color bgColor = t3_white,var showShadow=false}) {
  return BoxDecoration(
    //gradient: LinearGradient(colors: [bgColor, whiteColor]),
      color: bgColor,
      boxShadow: showShadow?[BoxShadow(color: shadow_color,blurRadius: 4,spreadRadius: 1)]:[BoxShadow(color: Colors.transparent)],
