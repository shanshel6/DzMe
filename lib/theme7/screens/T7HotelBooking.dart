      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            child: Image.asset(t7_ic_thailand_beach,fit: BoxFit.fill,),
          ),
          Column(
            children: <Widget>[
              Container(
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          divider(),
                          SizedBox(height: 10,),
                          Container(alignment:Alignment.center,child: T7Button(onPressed: (){},bgColor: t7view_color, textContent: t7_search_hotels,))
                        ],
                      ),
                    )
                  ],
