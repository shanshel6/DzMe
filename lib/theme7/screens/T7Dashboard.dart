    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
            boxShadow: [BoxShadow(color: t7ShadowColor,offset:Offset.fromDirection(3,1),spreadRadius: 1,blurRadius: 5)]
        ),
        child: T7BottomNavigationBar(
          ...
          unselectedIconTheme: IconThemeData(
              color: t7textColorSecondary,size: 24
          ),
          selectedIconTheme: IconThemeData(
              color: t7colorPrimary,size: 24
          ),
          onTap: _onItemTapped,
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      text(t7_hi_juila,fontSize: textSizeNormal,textColor: t7textColorPrimary),
                      Icon(
                        Icons.search,
                  ...
                  Row(
                    children: <Widget>[
                      text(t7_you_are_in_54_king_ports,textColor: t7textColorSecondary),
                    ],
                  )
                ],
              ),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      text(t7_best_destination,textColor: t7textColorPrimary,fontSize: textSizeLarge,),
                      text(t7_see_all,textColor: t7textColorSecondary,textAllCaps: true ),
                    ],
                  ),
                ),
                Container(
