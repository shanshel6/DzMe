        ...
        children: <Widget>[
          Container(
            height: MediaQuery.of(context).size.width / 1.5,
              child: Image.asset(t7_ic_hotel_room,fit: BoxFit.fill,),),
          Column(
            children: <Widget>[
              Container(
                ...
                alignment: Alignment.topLeft,
                  ...
                  child: backIcon(t7white,Icons.keyboard_arrow_left,t7textColorSecondary)),
              Padding(
             ...
             Padding(
               ...
               child: Column(
                 ...
                 children: <Widget>[
                   ...
                   divider(),
                   text(t7_description,textColor: t7textColorSecondary,isLongText: true),
                   SizedBox(height: 16,),
                   Container(
                     width: MediaQuery.of(context).size.width,
                     child: T7Button(bgColor: t7colorPrimary,textContent: t7_select_rorm, onPressed: () {},),
                   )
                 ],
               ),
             ),
