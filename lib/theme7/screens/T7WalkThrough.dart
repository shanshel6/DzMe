  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        child: PageView(
          children: <Widget>[
            WalkThrough(textContent: t7_walkthrough1,title: titles[currentIndexPage],info: subTitles[currentIndexPage],),
            WalkThrough(textContent: t7_walkthrough2,title: titles[currentIndexPage],info: subTitles[currentIndexPage],),
          ],
          onPageChanged: (value) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 20,),
                  T7Button(textContent: t7_get_started, onPressed: () {},bgColor: t7white,),
                  SizedBox(height: 16,),
