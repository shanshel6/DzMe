  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: CurvedNavigationBar(
        ...
        color: t3_white,
        items: <Widget>[
          SvgPicture.asset(t3_ic_home, height: 24,width: 24,fit: BoxFit.none,),
          SvgPicture.asset(t3_ic_msg, height: 24,width: 24,fit: BoxFit.none,),
          SvgPicture.asset(t3_notification, height: 24,width: 24,fit: BoxFit.none,),
          SvgPicture.asset(t3_ic_user, height: 24,width: 24,fit: BoxFit.none,),
        ],
        onTap: (index) {
