...
List<DB1FoodModel> getFoodItems() {
  ...
  item1.img = cafe;
  item1.name = "Alsaydia Coffee shop";
  item1.info = "Coffee shop";
  item1.duration = "30 min";

  DB1FoodModel item2 = DB1FoodModel();
  item2.img = resturant;
  item2.name = "mall baghdad resturant";
  item2.info = "resturant";
  item2.duration = "40 min";

  DB1FoodModel item3 = DB1FoodModel();
  item3.img = pharmacy;
  item3.name = "Baghdad Pharmacy";
  item3.info = "Pharmacy";
  item3.duration = "50 min";

  DB1FoodModel item4 = DB1FoodModel();
  item4.img = grocery;
  item4.name = "grocery in saydia";
  item4.info = "grocery";
  item4.duration = "30 min";
...
List<DB1FoodModel> getPopular() {
  ...
  DB1FoodModel item1 = DB1FoodModel();
  item1.img = cafe;
  item1.name = "Fukcing Coffee shop";
  item1.info = "cafe";
  item1.duration = "40 min";

  DB1FoodModel item2 = DB1FoodModel();
  item2.img = grocery;
  item2.name = "motha fucker grocery";
  item2.info = "grocery";
  item2.duration = "10 min";

  DB1FoodModel item3 = DB1FoodModel();
  item3.img = resturant;
  item3.name = "The motha faka resturant";
  item3.info = "resturant";
  item3.duration = "20 min";

  DB1FoodModel item4 = DB1FoodModel();
  item4.img = pharmacy;
  item4.name = "The shit pharmacy";
  item4.info = "pharmacy";
  item4.duration = "50 min";
