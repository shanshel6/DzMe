                      ...
                      child: Column(
                        children: <Widget>[
                          ClipRRect(
                            child: Stack(
                              children: <Widget>[
                                Image.asset(mCardss[index].image,width: width-32,height: width*0.5 ,fit: BoxFit.cover,),
                                Container(
                                  width: 50,
                                  height: 50,
                                  child: Icon(
                                    Icons.play_arrow,color: t4_colorPrimary,size: 30,
                                  ),
                            ...
                            children: <Widget>[
                              Expanded(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    text(mCardss[index].name,textColor: t4_textColorPrimary,fontSize: textSizeLargeMedium,fontFamily: fontBold),
                                    text(mCardss[index].info,fontSize: textSizeMedium,textColor: t4_textColorPrimary),
                                  ],
                                ),
                              ),
                              Row(
                                ...
                                children: <Widget>[
                                  SvgPicture.asset(t4_heart,width: 22,height: 22,),
                                  SizedBox(width: 16,),
                                  SvgPicture.asset(t4_share,width: 22,height: 22,color: t4_textColorPrimary,),
                                ],
                              )
                            ],
                          )
