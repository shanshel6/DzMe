    ...
    return Scaffold(
                            ...
                            itemBuilder: (context, index) {
                              return Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ClipRRect(
                                      child: Image.asset(mHorizontalListings[index].image,height: width*0.5,width: width*0.8,fit: BoxFit.fill,),
                                      ...
                                      child: Row(
                                        children: <Widget>[
                                          ...
                                          Row(
                                            ...
                                            children: <Widget>[
                                              SvgPicture.asset(t4_heart,width: 24,height: 24,),
                                              SizedBox(width: 16,),
                                              SvgPicture.asset(t4_share,width: 24,height: 24,color: t4_textColorPrimary,),
                                            ],
                                          )
                                        ],
                                      ),
                        ...
                        child: StaggeredGridView.countBuilder(
                          ...
                          itemBuilder: (BuildContext context, int index) => Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ClipRRect(
                                  child: Image.asset(mListings[index].image),
                                  borderRadius: BorderRadius.circular(4),
                                ),
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
          boxShadow: [BoxShadow(color: t4_shadow_color,offset:Offset.fromDirection(3,1),spreadRadius: 1,blurRadius: 5)]
        ),
        child: T4BottomNavigationBar(
          ...
          unselectedIconTheme: IconThemeData(
            color: t4_textColorSecondary,size: 24
          ),
          selectedIconTheme: IconThemeData(
            color: t4_colorPrimary,size: 24
          ),
          onTap: _onItemTapped,
