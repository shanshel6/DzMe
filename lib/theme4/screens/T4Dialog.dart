      ...
      child: Column(
        ...
        children: <Widget>[
          text("Would you like to get updates and notifications?",
              fontSize: textSizeLargeMedium, maxLine: 2, isCentered: true,textColor: t4_textColorPrimary,fontFamily: fontSemibold),
          SizedBox(height: 30),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              T4Button(textContent: t4_lbl_allow),
              SizedBox(width:24 ,),
              T4Button(textContent: t4_lbl_deny,isStroked: true,),
