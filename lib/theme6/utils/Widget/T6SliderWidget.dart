              ...
              child: Column(
                ...
                children: <Widget>[
                  ClipRRect(
                      ...
                      child: Image.asset(slider.Image, height: MediaQuery.of(context).size.height*0.15,
                        width: width,
                        fit: BoxFit.fill,)),
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            text(slider.name, textColor: t6textColorPrimary,
                                ...
                                children: [
                                  WidgetSpan(
                                    child: Padding(
                                      ...
                                      child: Icon(Icons.access_time,color: t6icon_color,size: 16,),
                                    ),
                                  ),
                                  TextSpan(text: slider.duration,style: TextStyle(
