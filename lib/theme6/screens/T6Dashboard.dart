                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Icon(Icons.notifications_active,color: t6icon_color,)
                            ],
                          ),
                          text(t6_lbl_how_was_your_day,
                              textColor: t6textColorPrimary,fontFamily: fontMedium)
                        ],
                      ),
                    ),
                  ),
                      ...
                      children: <Widget>[
                        Container(
                         ...
                         margin: EdgeInsets.only(left: 16,top: 16),
                          decoration: boxDecoration(
                              radius: 10, showShadow: true, bgColor: t6light_blue),
                          child: (
                              Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    circleProgressDashboard(
                                        "70.0g", t6_lbl_sugar, t6_lbl_sugar, 0.8),
                                    circleProgressDashboard(
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    circleProgressDashboard(
                                        "55.0g", t6_lbl_carbs, t6_lbl_over, 0.5),
                                    circleProgressDashboard(
                                        "70.0g", t6_lbl_protein, t6_lbl_over, 0.7),
                                  ],
                                )
                              ],
                            ),
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Flexible(child: tabItem(1, t6_ic_activity,t6_lbl_activity),flex: 1,),
                Flexible(child: tabItem(2, t6_ic_list,t6_lbl_health),flex: 1,),
                Flexible(child: tabItem(3, t6_ic_meal,t6_lbl_meals),flex: 1,),
                Flexible(child: tabItem(4, t6_ic_work_bn,t6_lbl_work),flex: 1,),
                Flexible(child: tabItem(5, t6_ic_sleep,t6_lbl_sleep),flex: 1,),
              ],
            ),
          ),
        ],
