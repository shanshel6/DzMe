          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                    alignment: Alignment.center,
                    child: Image.asset(t6_ic_logo,width: width/2.2)),
                SizedBox(height: 30,),
                ...
                SizedBox(height: 20,),
                T6Button(textContent: t6_lbl_sign_up, onPressed: () {},),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(width: 4,),
                    GestureDetector(
                        child: Text(t6_lbl_sign_in, style: TextStyle(fontSize: textSizeMedium,decoration: TextDecoration.underline, color: t6form_google)),
                        onTap: () {
                        }
                    )
                  ],
