          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 16,),
                T6Button(textContent: t6_lbl_sign_in, onPressed: () {},),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(width: 4,),
                    GestureDetector(
                        child: Text(t6_lbl_sign_up, style: TextStyle(fontSize: textSizeMedium,decoration: TextDecoration.underline, color: t6form_google)),
                        onTap: () {
                        }
                    )
                  ],
